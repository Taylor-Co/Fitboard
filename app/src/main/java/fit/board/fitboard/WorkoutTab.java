...
public class WorkoutTab{
    ...
    CurrentWorkoutLayout[] workoutRows;
    int lastWorkoutID = 0;
    ...
    public WorkoutTab(MainActivity activityIn){
        activity = activityIn;
        init();
    ...
    void loadWorkouts() {
        ...
        workoutRows = new CurrentWorkoutLayout[rows];

        for (int i = 0; i < rows; i++) {
            workoutRows[i] = new CurrentWorkoutLayout(activity.context, i);
    ...
    public void activeFinish() {
        ...
        activeExercises[activeIndex].setAlpha((float)0.5);
    ...
    class NewWorkoutLayout extends LinearLayout {
        ...
        public NewWorkoutLayout(Context context, int indexIn) {
            ...
            exerciseInput.setTextColor(Color.BLACK);
            ...
            exerciseInput.setHintTextColor(Color.DKGRAY);
    ...
    class ActiveExerciseLayout extends LinearLayout {
        ...
        public ActiveExerciseLayout(Context context) {
            ...
            infoButton.setPadding((int)(10 * getResources().getDisplayMetrics().density), (int)(10 * getResources().getDisplayMetrics().density), (int)(10 * getResources().getDisplayMetrics().density), (int)(10 * getResources().getDisplayMetrics().density));
            ...
            exerciseTV.setTextColor(Color.BLACK);
            ...
            exerciseInfoTV.setTextColor(Color.BLACK);
            ...
            repsTV.setTextColor(Color.BLACK);
            ...
            LayoutParams restLayoutParams = new LayoutParams(0, ViewGroup.LayoutParams.MATCH_PARENT, 1);
            ...
            activeTimerIcon.setImageResource(R.drawable.timer_icon);
            ...
            restTV.setTextColor(Color.BLACK);
